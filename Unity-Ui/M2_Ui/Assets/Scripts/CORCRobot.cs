...
namespace CORC
{
    ...
    public void Update()
    {
        if (Initialised && Client.IsConnected())
        {
        //    Debug.Log("Initialised: " + Initialised + ", Connected: " + Client.IsConnected());
            try
            {
            ...
            {
                Debug.LogError("Network read error: " + ex.Message);
                Disconnect();
            }
        ...
        /// </summary>
        public abstract void Init(string ip = "192.168.10.2", int port = 2048);
